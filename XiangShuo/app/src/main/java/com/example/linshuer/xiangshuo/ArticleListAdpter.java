...
/**
 * Created by Linshuer on 2018/6/14.
 */

public class ArticleListAdpter extends BaseAdapter {
    ...
    public ArticleListAdpter(Context context, List<Article> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view==null){
            ...
            viewHolder.articleid=(TextView)view.findViewById(R.id.v_id);
            viewHolder.date =(TextView)view.findViewById(R.id.v_date);
            viewHolder.type_inckname =(TextView)view.findViewById(R.id.v_type_nickname);
            viewHolder.title =(TextView)view.findViewById(R.id.v_title);
            viewHolder.p_pic =(ImageView)view.findViewById(R.id.v_image);
